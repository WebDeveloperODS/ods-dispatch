        ...
        <>
            <div className="container py-24 flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-4 gap-14 mt-8">
                    {
                        Steps.map((step,index) => <div key={index} className="flex flex-col gap-2 items-center bg-neutral-200 px-5 py-8 rounded-xl shadow-md text-center">
                            <div className="bg-blue-800 w-fit p-5 rounded-full shadow-md shadow-neutral-500 mb-3">{step.icons}</div>
                ...
                <FunctionButton extraClass={'border-2 text-blue-800 font-bold hover:border-transparent hover:text-neutral-100 hover:bg-blue-800 mt-10'}>Apply now</FunctionButton>
            </div>
            <div className="w-full py-14 flex items-center justify-center bg-red-700">
