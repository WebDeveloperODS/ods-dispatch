    ...
    return(
        <div className="container py-24 flex flex-col items-center justify-center">
            ...
            </div>
            {
                ...
                className={`relative bg-cover bg-center bg-no-repeat bg-left h-140 lg:min-h-140 w-full lg:w-[90%] rounded-xl ${activeTitle===index ? 'opacity-full flex':'opacity-0 hidden'} transition-all ease-in-out duration-400`}>
