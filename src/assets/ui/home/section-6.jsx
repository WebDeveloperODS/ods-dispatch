    ...
    const trucks = [
        {
            ...
            image: `${SERVER}/images/home/10.png`,
            pageLink:'/truck-types#dry-vans',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/17.png`,
            pageLink:'/truck-types#straight-box',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/11.png`,
            pageLink:'/truck-types#flatbed',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/15.png`,
            pageLink:'/truck-types#hotshot',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/12.png`,
            pageLink:'/truck-types#reefer',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/13.png`,
            pageLink:'/truck-types#step-deck',
        ...
        },
        {
            ...
            image: `${SERVER}/images/home/14.png`,
            pageLink:'/truck-types#rgn-heavy-haul',
            buttonText:'About RGN & Heavy Haul',
        },
    ]
    return(
        <div className="container py-14 lg:py-24 flex flex-col items-center justify-center">
            <H2 extraCss={'uppercase underline underline-offset-5 text-center lg:text-auto decoration-3 decoration-red-800'}>Types Of Trucks ODS <br className="lg:hidden"/> Deals With</H2>
            ...
            </div>
            {
                ...
                className={`relative bg-cover bg-center bg-no-repeat bg-left h-66 lg:min-h-140 w-full lg:w-[90%] rounded-xl ${activeTitle===index && window.innerWidth >=1024 ? 'opacity-full flex':'opacity-0 hidden'} transition-all ease-in-out duration-400`}>
            ...
            {
                trucks.map((truck,index) => <div key={index} 
                className={`relative rounded-xl ${activeTitle===index && window.innerWidth < 1024 ? 'opacity-full flex flex-col gap-5':'opacity-0 hidden'} transition-all ease-in-out duration-400`}>
                    <img src={truck.image} alt={truck.title} className="w-full h-full rounded-xl"/>
                    <div className="w-full h-full flex items-end lg:items-center">
                        <div className="flex flex-col lg:max-w-100 lg:w-100 gap-2 bg-neutral-800/80 p-6 lg:p-8 rounded-xl shadow-sm shadow-neutral-800">
                            <H2 extraCss={'text-neutral-100 tracking-wide '}>{truck.title}</H2>
                            <P2 extraClass="text-neutral-100 tracking-wider">{truck.content}</P2>
                            <PageButton addressLink={truck.pageLink} extraClass={'mt-3 bg-red-800 text-white w-fit text-sm! tracking-wide hover:-translate-y-1/12'}>{truck.buttonText}</PageButton>
