...
const About_ODS_Dispatch = () => {
  return (
    <div className='relative h-screen lg:h-[calc(100vh-1em)] bg-cover bg-fixed bg-center' style={{backgroundImage:`url(${import.meta.env.VITE_IMAGES_SERVER}/images/about-us/1.jpg)`}}>
        <div className="absolute top-0 left-0 w-full h-full bg-neutral-700/50 flex items-end justify-end pb-10 lg:pb-20">
            <div className="container bg-neutral-950/80 min-h-30 p-6 lg:p-15 rounded-xl flex flex-col gap-3">
                <H1 extraCss={'text-neutral-100 underline lg:underline-offset-8 decoration-3 decoration-red-800 text-shadow-lg/10'}>Truck Types We Dispatch at ODS Dispatch</H1>
