...
const About_ODS_Dispatch = () => {
  return (
    <div className='relative h-screen lg:h-[calc(100vh-1em)] bg-cover bg-fixed bg-center' style={{backgroundImage:'url(/images/about-us/1.jpg)'}}>
        <div className="absolute top-0 left-0 w-full h-full bg-neutral-700/50 flex items-end justify-end pb-20">
