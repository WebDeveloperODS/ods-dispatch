...
const TruckTypesIntro = () => {
  return (
    <div className='relative h-screen lg:h-[calc(100vh-1em)] bg-cover bg-fixed bg-center' style={{backgroundImage:`url(${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/1.png)`}}>
