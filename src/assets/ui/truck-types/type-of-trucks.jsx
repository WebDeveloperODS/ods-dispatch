...
const T_O_T_Descriptions = () => {
    const TrucksDetails = [
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/dry-van.png`,
        },
        {
        label: 'Straight Box',
        id:'straight-box',
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/flatbed.png`,
        },
        {
        label: 'Reefer',
        id:'reefer',
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/reefer.png`,
        },
        {
        label: 'Hotshot',
        id:'hotshot',
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/hotshot.png`,
        },
        {
        label: 'Step Deck',
        id:'step-deck',
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/step-deck.png`,
        },
        {
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/heavy-haul.png`,
        },
        {
        label: 'Power Only',
        id:'power-only',
        ...
        image: `${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/power-only.png`,
        }
    ];

    return (
    <div className="pt-8 lg:pt-24">
        <div className="container mb-8! lg:mb-24! relative rounded-xl bg-cover bg-fixed bg-center" style={{backgroundImage:`url(${import.meta.env.VITE_IMAGES_SERVER}/images/truck-types/bg.jpg)`}}>
            <div id="dry-vans" className="bg-neutral-800/60 p-4 text-center lg:text-start lg:p-10 rounded-xl flex flex-col gap-3 items-center justify-center min-h-30">
        ...
        <div id="trucks">
            {
                ...
                <div id={truck.id} className={`w-full flex flex-col mb-8 lg:mb-0 lg:grid lg:grid-cols-2 relative`} key={index}>    
                    { index%2 === 0 ? <div className="hidden lg:block"></div> : null }
                    <div>
                        <img src={truck.image}  className="object-center object-cover max-h-100 w-full"/>
                    </div>
                    { index%2!==0 ? <div className="hidden lg:block"> </div> : null }
                    <div className="relative lg:absolute container h-full top-0 left-0 right-0 my-8 lg:grid lg:grid-cols-2 ">
                        { index%2 === 0 ? <div className="flex flex-col gap-2 h-full justify-center my-5 px-5 lg:pl-0 lg:pr-12">
                        ...
                        { index%2!==0 ? <div className="flex flex-col gap-2 h-full justify-center my-5 px-5 lg:pr-0 lg:pl-12">
                            <H2 extraCss={'underline underline-offset-4 decoration-red-800 decoration-3'}>{truck.label}</H2>
                            <P1 extraClass="tracking-wide">{truck.description}</P1>
                            <PageButton addressLink={'/carriers-setup'} extraClass={'bg-red-800 rounded-xl mt-3 text-neutral-100 w-fit transition-all ease-in-out duration-300 hover:scale-[1.05]'}>Get your setup with ODS</PageButton>
                        </div> : null }
