...
const ContactPageHead = () => {
  return (
    <div className='relative h-screen lg:h-[calc(100vh-1em)] bg-fixed bg-cover bg-top' style={{backgroundImage:`url(${import.meta.env.VITE_IMAGES_SERVER}/images/contact-us/1.png)`}}>
